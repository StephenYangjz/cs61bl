...
public class AmoebaFamily implements Iterable<AmoebaFamily.Amoeba> {
    ...
    public void makeNamesLowercase() {
        ...
        if (root != null) {
            root.travelsal(String::toLowerCase);
        }
    }
    ...
    public static class Amoeba {
        ...
        public void travelsal(Function <String, String> getter) {
            if (children == null) {
                getter.apply(name);
            } else {
                for (Amoeba a : children) {
        ...
        public void replace(String currName, String newName) {
            if (name.equals(currName)) {
                name = newName;
            } else {
                for (Amoeba a : children) {
                    a.replace(currName, newName);
                }
            }
        }
        ...
        public String longestName() {
            String maxString = name;
            for (Amoeba a : children) {
                maxString = maxString.length() > a.longestName().length() ? maxString : a.longestName();
            }
            return maxString;
        }
    }
