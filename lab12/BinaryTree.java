...
public class BinaryTree {
    ...
    public void fillSampleTree3() {
        root = new TreeNode("A", new TreeNode("B", null, null), new TreeNode("C",
                new TreeNode("D", new TreeNode("E", null, null), new TreeNode("F", null, null)), null));
    }

    public void fillSampleTree4() {
        root = new TreeNode("A", new TreeNode("B", new TreeNode("D", null, null), new TreeNode("E", null, null)), new TreeNode("C",
                new TreeNode("D", null, null), new TreeNode("G", null, null)));
    }
    ...
    private static class TreeNode {
        ...
        public int height() {
            ...
            return left.height() > right.height() ? 1 + left.height() : 1 + right.height();
        }
    }
}
